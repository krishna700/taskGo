...
class CurvedNavBar extends StatefulWidget {
  ...
  CurvedNavBar({
    ...
    assert(appBarItems != null);
    assert(bodyItems != null);
    assert(appBarItems!.length == bodyItems!.length);
  }

  @override
  CurvedNavBarState createState() => CurvedNavBarState();
}

class CurvedNavBarState extends State<CurvedNavBar> {
